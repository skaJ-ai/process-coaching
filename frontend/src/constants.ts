...
export const SWIMLANE_COLORS = [
  { bg: 'rgba(59,130,246,0.04)', border: 'rgba(59,130,246,0.25)', text: '#60a5fa', label: '#93c5fd' },
  { bg: 'rgba(168,85,247,0.04)', border: 'rgba(168,85,247,0.25)', text: '#a855f7', label: '#c084fc' },
  { bg: 'rgba(34,197,94,0.04)', border: 'rgba(34,197,94,0.25)', text: '#22c55e', label: '#86efac' },
  { bg: 'rgba(245,158,11,0.04)', border: 'rgba(245,158,11,0.25)', text: '#f59e0b', label: '#fcd34d' },
  { bg: 'rgba(236,72,153,0.04)', border: 'rgba(236,72,153,0.25)', text: '#ec4899', label: '#f9a8d4' },
  { bg: 'rgba(20,184,166,0.04)', border: 'rgba(20,184,166,0.25)', text: '#14b8a6', label: '#5eead4' },
];
