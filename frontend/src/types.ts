...
export interface ChatMessage {
  ...
  quickQueries?: string[];
  quickActions?: { label: string; storeAction: 'toggleSwimLane' | 'advanceOnboarding' | 'skipOnboarding' | 'addSwimLaneAndAdvance' | 'focusStartNode' | 'focusEndNode' | 'startInterviewFlow' | 'convertToParallelSplit' | 'convertToParallelJoin'; noActioned?: boolean }[];
  timestamp: number;
  dismissible?: boolean;
  actioned?: boolean;
}
